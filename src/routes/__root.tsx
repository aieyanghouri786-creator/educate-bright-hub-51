...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cloud-based ERP and LMS platform that helps schools, colleges and universities manage admissions, attendance, fees, exams and learning." },
